import { getImageFixInfoVMPageList } from '@api/drawing'
...
export default function CheckOrder() {
  ...
  let [queryParams, setQueryParams] = useState<ImageFixInfoQuery>(initQuery)

  function goToDetailPage(fixInfo: ImageFixInfoVM) {
    navigate('/drawing/fix/detail/' + fixInfo.FixId)
  }
  async function loadData() {
    let res = await getImageFixInfoVMPageList(queryParams!, true)
    if (res.IsSuccess) {
      setQueryResult({
...
interface IItem {
  imageFixInfo: ImageFixInfoVM
  onItemClick: () => void
}
function Item(props: IItem) {
  let m = props.imageFixInfo
